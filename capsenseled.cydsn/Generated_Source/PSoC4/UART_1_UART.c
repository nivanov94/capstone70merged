...
{
#if (UART_1_SCB_MODE_UNCONFIG_CONST_CFG)
    #if (UART_1_TX_SCL_MISO_PIN)
        if (UART_1_CHECK_TX_SCL_MISO_PIN_USED)
        {
            /* Set SCB UART to drive the output pin */
            UART_1_SET_HSIOM_SEL(UART_1_TX_SCL_MISO_HSIOM_REG, UART_1_TX_SCL_MISO_HSIOM_MASK,
                                           UART_1_TX_SCL_MISO_HSIOM_POS, UART_1_TX_SCL_MISO_HSIOM_SEL_UART);
        }
    #endif /* (UART_1_TX_SCL_MISO_PIN_PIN) */
...
void UART_1_UartStop(void)
{
        ...
        if (UART_1_CHECK_TX_SCL_MISO_PIN_USED)
        {
            ...
            UART_1_SET_HSIOM_SEL(UART_1_TX_SCL_MISO_HSIOM_REG, UART_1_TX_SCL_MISO_HSIOM_MASK,
                                           UART_1_TX_SCL_MISO_HSIOM_POS, UART_1_TX_SCL_MISO_HSIOM_SEL_GPIO);
        }
    #endif /* (UART_1_TX_SCL_MISO_PIN_PIN) */
