...
#define CYBLE_GATT_DB_INDEX_COUNT                    (0x0023u)
#define CYBLE_GATT_DB_ATT_VAL_COUNT                  (0x1Du)
#define CYBLE_GATT_DB_MAX_VALUE_LEN                  (0x0016u)
...
extern const uint8 cyBle_attUuid128[8u][16u];
