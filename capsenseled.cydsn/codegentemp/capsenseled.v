...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=0, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=true, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=200, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=3, PWMStartPresent=true, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=true, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=true, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Mid_Thresh, CY_INSTANCE_SHORT_NAME=PWM_Mid_Thresh, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=PWM_Mid_Thresh, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=0, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=true, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=200, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=3, PWMStartPresent=true, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=true, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=true, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_Low_Thresh, CY_INSTANCE_SHORT_NAME=PWM_Low_Thresh, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=PWM_Low_Thresh, )
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART, CY_INSTANCE_SHORT_NAME=UART, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=UART, )
module SW_Tx_UART_v1_50_4 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("16dd4755-121a-4270-a1ec-694d5b2f68a7/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=127, Polarity=0, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC_Fire_Thresh, CY_INSTANCE_SHORT_NAME=IDAC_Fire_Thresh, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=IDAC_Fire_Thresh, )
...
module ADC_SAR_SEQ_P4_v2_40_6 (
    ...
    electrical  Net_1851;
    electrical  Net_2580;
    electrical [7:0] Net_2375;
    electrical [7:0] Net_1450;
    electrical  Net_3046;
    electrical  Net_3016;
          wire  Net_3235;
    electrical  Net_2099;
    ...
    Bus_Connect_v2_40 Connect_1 (
        ...
        .out_bus(Net_1450[7:0]));
    defparam Connect_1.in_width = 17;
    defparam Connect_1.out_width = 8;
	...
	cy_connect_v1_0 cy_analog_virtualmux_37_connect(Net_3016, mux_bus_plus[8]);
	...
	cy_connect_v1_0 cy_analog_virtualmux_36_connect(Net_3046, mux_bus_minus[8]);
    ...
    Bus_Connect_v2_40 Connect_2 (
        ...
        .out_bus(Net_2375[7:0]));
    defparam Connect_2.in_width = 17;
    defparam Connect_2.out_width = 8;
    ...
    cy_psoc4_sarmux_v1_0 cy_psoc4_sarmux_8 (
        .muxin_plus(Net_1450[7:0]),
        .muxin_minus(Net_2375[7:0]),
        .cmn_neg(Net_2580),
        .vout_plus(Net_2794),
        .vout_minus(Net_2793));
    defparam cy_psoc4_sarmux_8.input_mode = "00000000";
    defparam cy_psoc4_sarmux_8.muxin_width = 8;
	...
	cy_connect_v1_0 cy_analog_virtualmux_vplus5_connect(mux_bus_plus[5], vinPlus5);
	defparam cy_analog_virtualmux_vplus5_connect.sig_width = 1;

	// cy_analog_virtualmux_vplus6 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 cy_analog_virtualmux_vplus6_connect(mux_bus_plus[6], vinPlus6);
	defparam cy_analog_virtualmux_vplus6_connect.sig_width = 1;

	// cy_analog_virtualmux_vplus7 (cy_analog_virtualmux_v1_0)
	cy_connect_v1_0 cy_analog_virtualmux_vplus7_connect(mux_bus_plus[7], vinPlus7);
	...
	cy_clock_v1_0
		#(.id("6ca5ae94-a948-4add-b2f3-c4a57e7ba193/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("497453040.432983"),
		  .is_direct(0),
		  .is_digital(0))
		intClock
		 (.clock_out(Net_1845));
...
module top ;
	...
	wire [0:0] tmpOE__Mid_Thresh_net;
	wire [0:0] tmpFB_0__Mid_Thresh_net;
	wire [0:0] tmpIO_0__Mid_Thresh_net;
	wire [0:0] tmpINTERRUPT_0__Mid_Thresh_net;
	electrical [0:0] tmpSIOVREF__Mid_Thresh_net;

	cy_psoc3_pins_v1_10
		#(.id("88311896-33fd-4b14-a624-ec9fd52deb61"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Mid_Thresh
		 (.oe(tmpOE__Mid_Thresh_net),
		  .y({Net_60}),
		  .fb({tmpFB_0__Mid_Thresh_net[0:0]}),
		  .io({tmpIO_0__Mid_Thresh_net[0:0]}),
		  .siovref(tmpSIOVREF__Mid_Thresh_net),
		  .interrupt({tmpINTERRUPT_0__Mid_Thresh_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mid_Thresh_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWM_High_Thresh (
        .stop(1'b0),
        .reload(1'b0),
        .start(Net_81),
        .count(Net_360),
	...
	wire [0:0] tmpOE__Low_Thresh_net;
	wire [0:0] tmpFB_0__Low_Thresh_net;
	wire [0:0] tmpIO_0__Low_Thresh_net;
	wire [0:0] tmpINTERRUPT_0__Low_Thresh_net;
	electrical [0:0] tmpSIOVREF__Low_Thresh_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Low_Thresh
		 (.oe(tmpOE__Low_Thresh_net),
		  .y({Net_59}),
		  .fb({tmpFB_0__Low_Thresh_net[0:0]}),
		  .io({tmpIO_0__Low_Thresh_net[0:0]}),
		  .siovref(tmpSIOVREF__Low_Thresh_net),
		  .interrupt({tmpINTERRUPT_0__Low_Thresh_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Low_Thresh_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    TCPWM_P4_v2_10_1 PWM_Mid_Thresh (
        .stop(1'b0),
        .reload(1'b0),
        .start(Net_41),
        .count(Net_42),
    ...
    TCPWM_P4_v2_10_2 PWM_Low_Thresh (
        .stop(1'b0),
        .reload(1'b0),
        .start(Net_56),
        .count(Net_342),
    ...
    SW_Tx_UART_v1_50_4 UART ();

    assign Net_81 = 1'h1;

	wire [0:0] tmpOE__High_Thresh_net;
	wire [0:0] tmpFB_0__High_Thresh_net;
	wire [0:0] tmpIO_0__High_Thresh_net;
	wire [0:0] tmpINTERRUPT_0__High_Thresh_net;
	electrical [0:0] tmpSIOVREF__High_Thresh_net;

	cy_psoc3_pins_v1_10
		#(.id("c36fee25-fa44-4b9f-bb93-741c70652a75"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		High_Thresh
		 (.oe(tmpOE__High_Thresh_net),
		  .y({Net_82}),
		  .fb({tmpFB_0__High_Thresh_net[0:0]}),
		  .io({tmpIO_0__High_Thresh_net[0:0]}),
		  .siovref(tmpSIOVREF__High_Thresh_net),
		  .interrupt({tmpINTERRUPT_0__High_Thresh_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__High_Thresh_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2d44428d-e0bd-468e-ba7b-a2555fc21641"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LOW_FILTER_INPUT_net;
	wire [0:0] tmpIO_0__LOW_FILTER_INPUT_net;
	wire [0:0] tmpINTERRUPT_0__LOW_FILTER_INPUT_net;
	electrical [0:0] tmpSIOVREF__LOW_FILTER_INPUT_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		LOW_FILTER_INPUT
		 (.oe(tmpOE__LOW_FILTER_INPUT_net),
		  .y({1'b0}),
		  .fb({Net_636}),
		  .io({tmpIO_0__LOW_FILTER_INPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__LOW_FILTER_INPUT_net),
		  .interrupt({tmpINTERRUPT_0__LOW_FILTER_INPUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LOW_FILTER_INPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MED_FILTER_INPUT_net;
	wire [0:0] tmpIO_0__MED_FILTER_INPUT_net;
	wire [0:0] tmpINTERRUPT_0__MED_FILTER_INPUT_net;
	electrical [0:0] tmpSIOVREF__MED_FILTER_INPUT_net;

	cy_psoc3_pins_v1_10
		#(.id("836898b3-7546-45e9-ba0f-35ae2637cd17"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MED_FILTER_INPUT
		 (.oe(tmpOE__MED_FILTER_INPUT_net),
		  .y({1'b0}),
		  .fb({Net_637}),
		  .io({tmpIO_0__MED_FILTER_INPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__MED_FILTER_INPUT_net),
		  .interrupt({tmpINTERRUPT_0__MED_FILTER_INPUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MED_FILTER_INPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HIGH_FILTER_INPUT_net;
	wire [0:0] tmpIO_0__HIGH_FILTER_INPUT_net;
	wire [0:0] tmpINTERRUPT_0__HIGH_FILTER_INPUT_net;
	electrical [0:0] tmpSIOVREF__HIGH_FILTER_INPUT_net;

	cy_psoc3_pins_v1_10
		#(.id("5a8e0a17-845b-4232-a458-5fb40889a376"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HIGH_FILTER_INPUT
		 (.oe(tmpOE__HIGH_FILTER_INPUT_net),
		  .y({1'b0}),
		  .fb({Net_638}),
		  .io({tmpIO_0__HIGH_FILTER_INPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__HIGH_FILTER_INPUT_net),
		  .interrupt({tmpINTERRUPT_0__HIGH_FILTER_INPUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HIGH_FILTER_INPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("6599f3a4-939a-4c54-b9ec-60ff28eecfd3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__USER_INPUT_net;
	wire [0:0] tmpIO_0__USER_INPUT_net;
	wire [0:0] tmpINTERRUPT_0__USER_INPUT_net;
	electrical [0:0] tmpSIOVREF__USER_INPUT_net;

	cy_psoc3_pins_v1_10
		#(.id("ca4b0534-a54a-470f-948d-caf072ffdec5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		USER_INPUT
		 (.oe(tmpOE__USER_INPUT_net),
		  .y({1'b0}),
		  .fb({Net_660}),
		  .io({tmpIO_0__USER_INPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__USER_INPUT_net),
		  .interrupt({tmpINTERRUPT_0__USER_INPUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__USER_INPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__FIRE_FILTER_INPUT_net;
	wire [0:0] tmpIO_0__FIRE_FILTER_INPUT_net;
	wire [0:0] tmpINTERRUPT_0__FIRE_FILTER_INPUT_net;
	electrical [0:0] tmpSIOVREF__FIRE_FILTER_INPUT_net;

	cy_psoc3_pins_v1_10
		#(.id("6952e386-212c-45b8-b6c8-887b075e08b3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		FIRE_FILTER_INPUT
		 (.oe(tmpOE__FIRE_FILTER_INPUT_net),
		  .y({1'b0}),
		  .fb({Net_661}),
		  .io({tmpIO_0__FIRE_FILTER_INPUT_net[0:0]}),
		  .siovref(tmpSIOVREF__FIRE_FILTER_INPUT_net),
		  .interrupt({tmpINTERRUPT_0__FIRE_FILTER_INPUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FIRE_FILTER_INPUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    IDAC_P4_v1_10_5 IDAC_Fire_Thresh (
        .Iout(Net_62));

	wire [0:0] tmpOE__Fire_Thresh_net;
	wire [0:0] tmpFB_0__Fire_Thresh_net;
	wire [0:0] tmpIO_0__Fire_Thresh_net;
	wire [0:0] tmpINTERRUPT_0__Fire_Thresh_net;
	electrical [0:0] tmpSIOVREF__Fire_Thresh_net;

	cy_psoc3_pins_v1_10
		#(.id("acc25417-f951-4972-a2b0-0e5f9c47dca7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Fire_Thresh
		 (.oe(tmpOE__Fire_Thresh_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fire_Thresh_net[0:0]}),
		  .analog({Net_62}),
		  .io({tmpIO_0__Fire_Thresh_net[0:0]}),
		  .siovref(tmpSIOVREF__Fire_Thresh_net),
		  .interrupt({tmpINTERRUPT_0__Fire_Thresh_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fire_Thresh_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_40_6 ADC_SAR_Seq_1 (
        .Vref(Net_704),
        .sdone(Net_705),
        .eoc(Net_706),
        .aclk(1'b0),
	...
	wire [0:0] tmpOE__Low_Thresh_Feedback_net;
	wire [0:0] tmpFB_0__Low_Thresh_Feedback_net;
	wire [0:0] tmpIO_0__Low_Thresh_Feedback_net;
	wire [0:0] tmpINTERRUPT_0__Low_Thresh_Feedback_net;
	electrical [0:0] tmpSIOVREF__Low_Thresh_Feedback_net;

	cy_psoc3_pins_v1_10
		#(.id("22ceb6bd-bc13-450e-b37a-b463f01200b2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Low_Thresh_Feedback
		 (.oe(tmpOE__Low_Thresh_Feedback_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Low_Thresh_Feedback_net[0:0]}),
		  .analog({Net_196}),
		  .io({tmpIO_0__Low_Thresh_Feedback_net[0:0]}),
		  .siovref(tmpSIOVREF__Low_Thresh_Feedback_net),
		  .interrupt({tmpINTERRUPT_0__Low_Thresh_Feedback_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Low_Thresh_Feedback_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mid_Thresh_Feedback_net;
	wire [0:0] tmpFB_0__Mid_Thresh_Feedback_net;
	wire [0:0] tmpIO_0__Mid_Thresh_Feedback_net;
	wire [0:0] tmpINTERRUPT_0__Mid_Thresh_Feedback_net;
	electrical [0:0] tmpSIOVREF__Mid_Thresh_Feedback_net;

	cy_psoc3_pins_v1_10
		#(.id("08a5f27e-01ac-4308-bcf2-131d8b84c96b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Mid_Thresh_Feedback
		 (.oe(tmpOE__Mid_Thresh_Feedback_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mid_Thresh_Feedback_net[0:0]}),
		  .analog({Net_194}),
		  .io({tmpIO_0__Mid_Thresh_Feedback_net[0:0]}),
		  .siovref(tmpSIOVREF__Mid_Thresh_Feedback_net),
		  .interrupt({tmpINTERRUPT_0__Mid_Thresh_Feedback_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mid_Thresh_Feedback_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__High_Thresh_Feedback_net;
	wire [0:0] tmpFB_0__High_Thresh_Feedback_net;
	wire [0:0] tmpIO_0__High_Thresh_Feedback_net;
	wire [0:0] tmpINTERRUPT_0__High_Thresh_Feedback_net;
	electrical [0:0] tmpSIOVREF__High_Thresh_Feedback_net;

	cy_psoc3_pins_v1_10
		#(.id("fc57ce6d-b947-4bc5-8e5d-b3741832f92b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		High_Thresh_Feedback
		 (.oe(tmpOE__High_Thresh_Feedback_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__High_Thresh_Feedback_net[0:0]}),
		  .analog({Net_192}),
		  .io({tmpIO_0__High_Thresh_Feedback_net[0:0]}),
		  .siovref(tmpSIOVREF__High_Thresh_Feedback_net),
		  .interrupt({tmpINTERRUPT_0__High_Thresh_Feedback_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__High_Thresh_Feedback_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Fire_Thresh_Feedback_net;
	wire [0:0] tmpFB_0__Fire_Thresh_Feedback_net;
	wire [0:0] tmpIO_0__Fire_Thresh_Feedback_net;
	wire [0:0] tmpINTERRUPT_0__Fire_Thresh_Feedback_net;
	electrical [0:0] tmpSIOVREF__Fire_Thresh_Feedback_net;

	cy_psoc3_pins_v1_10
		#(.id("fe13d1f1-fd64-4d40-b1bf-f85f4ab14c20"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		Fire_Thresh_Feedback
		 (.oe(tmpOE__Fire_Thresh_Feedback_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fire_Thresh_Feedback_net[0:0]}),
		  .analog({Net_190}),
		  .io({tmpIO_0__Fire_Thresh_Feedback_net[0:0]}),
		  .siovref(tmpSIOVREF__Fire_Thresh_Feedback_net),
		  .interrupt({tmpINTERRUPT_0__Fire_Thresh_Feedback_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fire_Thresh_Feedback_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("c638c565-d665-43fb-9905-504f3c1200d6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PGA_CS_net;
	wire [0:0] tmpFB_0__PGA_CS_net;
	wire [0:0] tmpIO_0__PGA_CS_net;
	wire [0:0] tmpINTERRUPT_0__PGA_CS_net;
	electrical [0:0] tmpSIOVREF__PGA_CS_net;

	cy_psoc3_pins_v1_10
		#(.id("4b49fff4-83d7-4782-adc1-f2d0159700f0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PGA_CS
		 (.oe(tmpOE__PGA_CS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PGA_CS_net[0:0]}),
		  .io({tmpIO_0__PGA_CS_net[0:0]}),
		  .siovref(tmpSIOVREF__PGA_CS_net),
		  .interrupt({tmpINTERRUPT_0__PGA_CS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PGA_CS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PGA_U_Db_net;
	wire [0:0] tmpFB_0__PGA_U_Db_net;
	wire [0:0] tmpIO_0__PGA_U_Db_net;
	wire [0:0] tmpINTERRUPT_0__PGA_U_Db_net;
	electrical [0:0] tmpSIOVREF__PGA_U_Db_net;

	cy_psoc3_pins_v1_10
		#(.id("a75b763e-1c9e-496f-9949-3c45fe0d2156"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PGA_U_Db
		 (.oe(tmpOE__PGA_U_Db_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PGA_U_Db_net[0:0]}),
		  .io({tmpIO_0__PGA_U_Db_net[0:0]}),
		  .siovref(tmpSIOVREF__PGA_U_Db_net),
		  .interrupt({tmpINTERRUPT_0__PGA_U_Db_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PGA_U_Db_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PGA_INC_net;
	wire [0:0] tmpFB_0__PGA_INC_net;
	wire [0:0] tmpIO_0__PGA_INC_net;
	wire [0:0] tmpINTERRUPT_0__PGA_INC_net;
	electrical [0:0] tmpSIOVREF__PGA_INC_net;

	cy_psoc3_pins_v1_10
		#(.id("f33e3c83-444d-4a5f-a448-c0b0ef6df366"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PGA_INC
		 (.oe(tmpOE__PGA_INC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PGA_INC_net[0:0]}),
		  .io({tmpIO_0__PGA_INC_net[0:0]}),
		  .siovref(tmpSIOVREF__PGA_INC_net),
		  .interrupt({tmpINTERRUPT_0__PGA_INC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PGA_INC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("122fa51a-3c49-4a3a-8c2a-72df758a945e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("2000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Low_Peak_net;
	wire [0:0] tmpFB_0__Low_Peak_net;
	wire [0:0] tmpIO_0__Low_Peak_net;
	wire [0:0] tmpINTERRUPT_0__Low_Peak_net;
	electrical [0:0] tmpSIOVREF__Low_Peak_net;

	cy_psoc3_pins_v1_10
		#(.id("983e7cf0-61c9-4927-9434-e47e4613e77e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Low_Peak
		 (.oe(tmpOE__Low_Peak_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Low_Peak_net[0:0]}),
		  .analog({Net_775}),
		  .io({tmpIO_0__Low_Peak_net[0:0]}),
		  .siovref(tmpSIOVREF__Low_Peak_net),
		  .interrupt({tmpINTERRUPT_0__Low_Peak_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Low_Peak_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Mid_Peak_net;
	wire [0:0] tmpFB_0__Mid_Peak_net;
	wire [0:0] tmpIO_0__Mid_Peak_net;
	wire [0:0] tmpINTERRUPT_0__Mid_Peak_net;
	electrical [0:0] tmpSIOVREF__Mid_Peak_net;

	cy_psoc3_pins_v1_10
		#(.id("29b1e76d-070d-4b0a-bec5-9145b952659a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Mid_Peak
		 (.oe(tmpOE__Mid_Peak_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Mid_Peak_net[0:0]}),
		  .analog({Net_774}),
		  .io({tmpIO_0__Mid_Peak_net[0:0]}),
		  .siovref(tmpSIOVREF__Mid_Peak_net),
		  .interrupt({tmpINTERRUPT_0__Mid_Peak_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Mid_Peak_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__High_Peak_net;
	wire [0:0] tmpFB_0__High_Peak_net;
	wire [0:0] tmpIO_0__High_Peak_net;
	wire [0:0] tmpINTERRUPT_0__High_Peak_net;
	electrical [0:0] tmpSIOVREF__High_Peak_net;

	cy_psoc3_pins_v1_10
		#(.id("63b0ddb4-0773-4355-8c7c-1a21f05c7744"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		High_Peak
		 (.oe(tmpOE__High_Peak_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__High_Peak_net[0:0]}),
		  .analog({Net_777}),
		  .io({tmpIO_0__High_Peak_net[0:0]}),
		  .siovref(tmpSIOVREF__High_Peak_net),
		  .interrupt({tmpINTERRUPT_0__High_Peak_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__High_Peak_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Fire_Peak_net;
	wire [0:0] tmpFB_0__Fire_Peak_net;
	wire [0:0] tmpIO_0__Fire_Peak_net;
	wire [0:0] tmpINTERRUPT_0__Fire_Peak_net;
	electrical [0:0] tmpSIOVREF__Fire_Peak_net;

	cy_psoc3_pins_v1_10
		#(.id("a45da3a6-a3c6-4810-9bae-7f93bd3f19b9"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Fire_Peak
		 (.oe(tmpOE__Fire_Peak_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Fire_Peak_net[0:0]}),
		  .analog({Net_781}),
		  .io({tmpIO_0__Fire_Peak_net[0:0]}),
		  .siovref(tmpSIOVREF__Fire_Peak_net),
		  .interrupt({tmpINTERRUPT_0__Fire_Peak_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Fire_Peak_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
