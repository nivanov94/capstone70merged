...
/* Signal present */
#define Timer_QUAD_INDEX_SIGNAL_PRESENT      (1lu)
#define Timer_QUAD_STOP_SIGNAL_PRESENT       (1lu)
...
/* Interrupt Mask */
#define Timer_TC_INTERRUPT_MASK              (3lu)
...
/* Signal present */
#define Timer_PWM_RELOAD_SIGNAL_PRESENT      (1lu)
#define Timer_PWM_COUNT_SIGNAL_PRESENT       (1lu)
#define Timer_PWM_START_SIGNAL_PRESENT       (1lu)
#define Timer_PWM_STOP_SIGNAL_PRESENT        (1lu)
#define Timer_PWM_SWITCH_SIGNAL_PRESENT      (1lu)
...
#define Timer_TC_COMPARE_VALUE               (20000lu)
...
#define Timer_PWM_PERIOD_SWAP                (1lu)
