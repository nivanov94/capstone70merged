    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x0117u] = {
    /* Device Name */
    (uint8)'O', (uint8)'T', (uint8)'A', 
...
(uint8)'i', (uint8)'n', (uint8)'t', (uint8)'1', (uint8)'6', 
    ...
    /* Characteristic User Description */
    (uint8)'v', (uint8)'i', (uint8)'b', (uint8)'I', (uint8)'n', (uint8)'t', (uint8)'e', (uint8)'n', (uint8)'s', (uint8)'i',
(uint8)'t', (uint8)'y', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'8', 

    /* alarmStatus */
    0x00u, 

    /* Characteristic User Description */
    (uint8)'a', (uint8)'l', (uint8)'a', (uint8)'r', (uint8)'m', (uint8)'T', (uint8)'y', (uint8)'p', (uint8)'e', (uint8)' ',
(uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'8', 

    /* vibDuration */
    0x00u, 

    /* Characteristic User Description */
    (uint8)'v', (uint8)'i', (uint8)'b', (uint8)'T', (uint8)'y', (uint8)'p', (uint8)'e', (uint8)' ', (uint8)'u', (uint8)'i',
(uint8)'n', (uint8)'t', (uint8)'8', 

    /* alarmVibType */
    0x00u, 

    /* Characteristic User Description */
    (uint8)'a', (uint8)'l', (uint8)'a', (uint8)'r', (uint8)'m', (uint8)'V', (uint8)'i', (uint8)'b', (uint8)'T', (uint8)'y',
(uint8)'p', (uint8)'e', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n', (uint8)'t', (uint8)'8', 

    /* ambulanceVibType */
    0x00u, 

    /* Characteristic User Description */
    (uint8)'a', (uint8)'m', (uint8)'b', (uint8)'u', (uint8)'l', (uint8)'a', (uint8)'n', (uint8)'c', (uint8)'e', (uint8)'V',
(uint8)'i', (uint8)'b', (uint8)'T', (uint8)'y', (uint8)'p', (uint8)'e', (uint8)' ', (uint8)'u', (uint8)'i', (uint8)'n',
(uint8)'t', (uint8)'8', 
...
const uint8 cyBle_attUuid128[][16u] = {
    ...
    /* alarmStatus */
    { 0xF5u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u },
    /* vibDuration */
    { 0xF6u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u },
    /* alarmVibType */
    { 0xF7u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u },
    /* ambulanceVibType */
    { 0xF8u, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u, 0x00u },
    /* Bootloader */
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0004u, (void *)&cyBle_attValues[13] }, /* Service Changed */
    ...
    { 0x0001u, (void *)&cyBle_attValues[17] }, /* led */
    { 0x0009u, (void *)&cyBle_attValues[18] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* capsense UUID */
    { 0x0002u, (void *)&cyBle_attValues[27] }, /* capsense */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* capsensecccd */
    { 0x000Fu, (void *)&cyBle_attValues[29] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[3] }, /* vibIntensity UUID */
    { 0x0001u, (void *)&cyBle_attValues[44] }, /* vibIntensity */
    { 0x0012u, (void *)&cyBle_attValues[45] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[4] }, /* alarmStatus UUID */
    { 0x0001u, (void *)&cyBle_attValues[63] }, /* alarmStatus */
    { 0x000Fu, (void *)&cyBle_attValues[64] }, /* Characteristic User Description */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[4] }, /* alarmStatusCCCD */
    { 0x0010u, (void *)&cyBle_attUuid128[5] }, /* vibDuration UUID */
    { 0x0001u, (void *)&cyBle_attValues[79] }, /* vibDuration */
    { 0x000Du, (void *)&cyBle_attValues[80] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[6] }, /* alarmVibType UUID */
    { 0x0001u, (void *)&cyBle_attValues[93] }, /* alarmVibType */
    { 0x0012u, (void *)&cyBle_attValues[94] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[7] }, /* ambulanceVibType UUID */
    { 0x0001u, (void *)&cyBle_attValues[112] }, /* ambulanceVibType */
    { 0x0016u, (void *)&cyBle_attValues[113] }, /* Characteristic User Description */
    { 0x0010u, (void *)&cyBle_attUuid128[8] }, /* Bootloader UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[9] }, /* Command UUID */
    { 0x0090u, (void *)&cyBle_attValues[135] }, /* Command */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[6] }, /* Client Characteristic Configuration */
};

const CYBLE_GATTS_DB_T cyBle_gattDB[0x27u] = {
    ...
    { 0x0003u, 0x2A00u /* Device Name                         */, 0x00000201u /* rd        */, 0x0003u, {{0x0003u, (void *)&cyBle_attValuesLen[0]}} },
    ...
    { 0x000Cu, 0x2800u /* Primary service                     */, 0x00080001u /*           */, 0x0023u, {{0x0010u, (void *)&cyBle_attValuesLen[5]}} },
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr     */, 0x000Fu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0x0000u /* led                                 */, 0x00090A0Fu /* rd,wr     */, 0x000Fu, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    ...
    { 0x0011u, 0x0000u /* capsense                            */, 0x00091209u /* rd,ntf    */, 0x0013u, {{0x0002u, (void *)&cyBle_attValuesLen[10]}} },
    { 0x0012u, 0x2902u /* capsensecccd                        */, 0x00010A0Eu /* rd,wr     */, 0x0012u, {{0x0002u, (void *)&cyBle_attValuesLen[11]}} },
    ...
    { 0x0015u, 0x0000u /* vibIntensity                        */, 0x00090A0Fu /* rd,wr     */, 0x0016u, {{0x0001u, (void *)&cyBle_attValuesLen[14]}} },
    { 0x0016u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x0016u, {{0x0012u, (void *)&cyBle_attValuesLen[15]}} },
    { 0x0017u, 0x2803u /* Characteristic                      */, 0x00001A01u /* rd,wr,ntf */, 0x001Au, {{0x0010u, (void *)&cyBle_attValuesLen[16]}} },
    { 0x0018u, 0x0000u /* alarmStatus                         */, 0x00091A0Fu /* rd,wr,ntf */, 0x001Au, {{0x0001u, (void *)&cyBle_attValuesLen[17]}} },
    { 0x0019u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x0019u, {{0x000Fu, (void *)&cyBle_attValuesLen[18]}} },
    { 0x001Au, 0x2902u /* alarmStatusCCCD                     */, 0x00010A0Eu /* rd,wr     */, 0x001Au, {{0x0002u, (void *)&cyBle_attValuesLen[19]}} },
    { 0x001Bu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr     */, 0x001Du, {{0x0010u, (void *)&cyBle_attValuesLen[20]}} },
    { 0x001Cu, 0x0000u /* vibDuration                         */, 0x00090A0Fu /* rd,wr     */, 0x001Du, {{0x0001u, (void *)&cyBle_attValuesLen[21]}} },
    { 0x001Du, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x001Du, {{0x000Du, (void *)&cyBle_attValuesLen[22]}} },
    { 0x001Eu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr     */, 0x0020u, {{0x0010u, (void *)&cyBle_attValuesLen[23]}} },
    { 0x001Fu, 0x0000u /* alarmVibType                        */, 0x00090A0Fu /* rd,wr     */, 0x0020u, {{0x0001u, (void *)&cyBle_attValuesLen[24]}} },
    { 0x0020u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x0020u, {{0x0012u, (void *)&cyBle_attValuesLen[25]}} },
    { 0x0021u, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr     */, 0x0023u, {{0x0010u, (void *)&cyBle_attValuesLen[26]}} },
    { 0x0022u, 0x0000u /* ambulanceVibType                    */, 0x00090A0Fu /* rd,wr     */, 0x0023u, {{0x0001u, (void *)&cyBle_attValuesLen[27]}} },
    { 0x0023u, 0x2901u /* Characteristic User Description     */, 0x00010201u /* rd        */, 0x0023u, {{0x0016u, (void *)&cyBle_attValuesLen[28]}} },
    { 0x0024u, 0x2800u /* Primary service                     */, 0x00080001u /*           */, 0x0027u, {{0x0010u, (void *)&cyBle_attValuesLen[29]}} },
    { 0x0025u, 0x2803u /* Characteristic                      */, 0x00001801u /* wr,ntf    */, 0x0027u, {{0x0010u, (void *)&cyBle_attValuesLen[30]}} },
    { 0x0026u, 0x0001u /* Command                             */, 0x0008180Au /* wr,ntf    */, 0x0027u, {{0x0090u, (void *)&cyBle_attValuesLen[31]}} },
    { 0x0027u, 0x2902u /* Client Characteristic Configuration */, 0x00000A0Eu /* rd,wr     */, 0x0027u, {{0x0002u, (void *)&cyBle_attValuesLen[32]}} },
};
